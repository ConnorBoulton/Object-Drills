...
const favoriteThings = {
  band: 'Pink Floyd',
  food: 'Marble Cake',
  person: 'somebody that I used to know',
  book: '1984',
...
let num = totalPopulation(states)
console.log(num)
//////////////////////////// PROBLEM 9 ////////////////////////////
...
function ingredients(obj){
  ...
  let data = [];
  let data_arr = data.push(obj)
  return data
}

let foods = ingredients(macros);
console.log(foods)
//////////////////////////// PROBLEM 10 ////////////////////////////
// Do not edit the code below.
var user = {
...
let cat1 = new Cat('snowball', 8, 'white');
...
let wizard1 = new Wizard('Xenu', 478, 'lightning Bolt')
...
class Phone {
  ...
  sell(){
    this.sold_properties = !this.sold_properties;
...
//Code Here
let nokia = new Phone('nokia', 'brick', 124, 'purple', 399.99);
let iphone = new Phone('iphone', '20 pro deluxe mega edition', 32, 'blue', 1999.99);
let android = new Phone('Samsung', 'Galaxy A12', 32, 'black', 199.99);
/* 
